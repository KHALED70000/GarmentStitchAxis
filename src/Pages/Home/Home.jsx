...
const Home = () => {
    ...
    const feedbackData = [
        { name: "Alice", role: "Buyer", comment: "Great quality, fast delivery!" },
        { name: "Bob", role: "Manager", comment: "Efficient and professional service." },
        { name: "Carol", role: "Buyer", comment: "Loved the variety of products." },
    ];
    ...
    return (
        <div>
            ...
            <div>
                <CustomerFeedback feedbacks={feedbackData}></CustomerFeedback>
            </div>
        </div>
    );
};
